...
st.sidebar.text('Take a time period like 2y, 5y, 6y, max etc.')
...
st.sidebar.text('For other Ticker or Company refer a yahoo finance website : https://finance.yahoo.com/')
